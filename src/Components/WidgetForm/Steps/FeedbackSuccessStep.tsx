  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center py-10 w-[304px]'>
        ...
        <span className='text-xl font-medium mt-2 leading-6'>
        ...
        <button
          ...
          className='py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus-styles'
        >
          Quero enviar outro
        </button>
      </div>
